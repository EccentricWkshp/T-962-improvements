...
// MG Chemicals 4860P Sn63Pb37 profile
static const profile nc31profile = {
	"MG 4860P Sn63Pb37", {
		 50, 50, 50, 50, 55, 64, 73, 82, 91,100,108,116,125,129,133,138, // 0-150s
		142,146,150,154,158,163,167,171,175,179,183,188,192,196,200,208, // 160-310s
		217,225,225,211,197,183,168,154,140,126,111, 97, 83, 68,  0,  0  // 320-470s
	}
};
